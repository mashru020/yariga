        ...
        >
          ...
          <Stack direction='row' gap={4}>
            <FormControl sx={{flex:1}}> 
              ...
              <Select
                ...
                {...register('propertyType',{requited: true})}
              >
            ...
            <FormControl>
            <FormHelperText sx={{fontWeight:500, margin:'10px 0', fontSize:16, color:"#11142d"}}>Property price</FormHelperText>
            <TextField
              fullWidth
              required
              id='outlined-basic'
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            <Stack direction='row' gap={2}>
              ...
              <Button component='label'sx={{width:'fin-content', color:'#2ed480', textTransform:'capitalize', fontSize:16}}>
                Upload *
                <input
                  hidden
                  accept='image/*'
            ...
            <CustomButton 
              type='submit'
              title={formLoading ? 'Submittion...' : 'Submit'}
